...
puts "what will your first number be?(if exponenent, this is the base for exponent. if square root, this is the number you want to square root)"
first_number = gets.chomp.to_f

puts "what will your second number be?(if square root, enter '.5')"
